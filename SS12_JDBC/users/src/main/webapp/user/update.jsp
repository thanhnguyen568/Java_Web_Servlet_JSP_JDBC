            ...
            <form method="post">
                <table>
                    ...
                    <tr>
                        <th>User Name:</th>
                        <td>
                            <input class="form-control" name="name" size="45" value="<c:out value='${user.name}' />"/>
                        </td>
                    </tr>
                    <tr>
                        <th>User Email:</th>
                        <td>
                            <input class="form-control" name="email" size="45" value="<c:out value='${user.email}' />"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Country:</th>
                        <td>
                            <input class="form-control" name="country" size="15"
