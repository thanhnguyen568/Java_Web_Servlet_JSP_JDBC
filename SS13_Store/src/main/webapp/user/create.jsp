            ...
            <form method="post">
                <table>
                    <tr>
                        <th>User Name:</th>
                        <td>
                            <input class="form-control" name="name" id="name" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>User Email:</th>
                        <td>
                            <input class="form-control" name="email" id="email" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Country:</th>
                        <td>
                            <input class="form-control" name="country" id="country" size="15"/>
                        </td>
                    </tr>
                    <tr>
